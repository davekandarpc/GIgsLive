...
const TRANSLATE_VALUE = Math.round((SLIDER_WIDTH * 0.01) / 3);

export function scrollInterpolatorInfinite(index, carouselProps) {
  const range = [1, 0, -1];
...
export function animatedStylesInfinite(index, animatedValue, carouselProps) {
