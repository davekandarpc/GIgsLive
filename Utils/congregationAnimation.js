...
const TRANSLATE_VALUE = Math.round((SLIDER_WIDTH * 0.01 * 2) / 5);

export function scrollInterpolatorCongo(index, carouselProps) {
  const range = [1, 0, -1];
...
export function animatedStylesCongo(index, animatedValue, carouselProps) {
